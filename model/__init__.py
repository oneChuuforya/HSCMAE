...
pretrain_default_model_kwargs = {
    ...
    'convnext_tiny': dict(sparse=True, drop_path_rate=0.1),
...
def build_sparse_encoder(name: str,unet_layers, depths, dims,bigkernel, input_size: int, sbn=False, drop_path_rate=0.0, verbose=False):
